...
@Processor('job-sunat-submission-manual')
export class SunatManualProcessor {
  private readonly logger = new Logger(SunatManualProcessor.name);
  ...
  @Process('submitSunatManualWithValidation')
